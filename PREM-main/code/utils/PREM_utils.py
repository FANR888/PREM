...
def context_mask(img, pattern):
    ...
    if pattern == 1:
        ...
        patch_pixel_x1, patch_pixel_y1, patch_pixel_z1 = int(patch_pixel_x*2/3), int( patch_pixel_y*2/3), int( patch_pixel_z*2/3)
        w1 = np.random.randint(0, patch_pixel_x - patch_pixel_x1)
        h1 = np.random.randint(0, patch_pixel_y- patch_pixel_y1)
        z1 = np.random.randint(0, patch_pixel_z- patch_pixel_z1)
        mask[w1:w1+patch_pixel_x1, h1:h1+patch_pixel_y1, z1:z1+patch_pixel_z1] = 1
        loss_mask[:, w1:w1+patch_pixel_x1, h1:h1+patch_pixel_y1, z1:z1+patch_pixel_z1] = 1
    elif pattern == 2:
        patch_pixel_x, patch_pixel_y, patch_pixel_z = int(img_x*2/3), int(img_y*2/3), int(img_z*2/3)
        w = np.random.randint(0, 112 - patch_pixel_x)
        h = np.random.randint(0, 112 - patch_pixel_y)
        ...
        mask[w:w+patch_pixel_x, h:h+patch_pixel_y, z:z+patch_pixel_z] = 0
        loss_mask[:, w:w+patch_pixel_x, h:h+patch_pixel_y, z:z+patch_pixel_z] = 0
        patch_pixel_x1, patch_pixel_y1, patch_pixel_z1 = int(patch_pixel_x*1/3), int( patch_pixel_y*1/3), int( patch_pixel_z*1/3)
        w1 = np.random.randint(0, patch_pixel_x - patch_pixel_x1)
        h1 = np.random.randint(0, patch_pixel_y- patch_pixel_y1)
        z1 = np.random.randint(0, patch_pixel_z- patch_pixel_z1)
        mask[w1:w1+patch_pixel_x1, h1:h1+patch_pixel_y1, z1:z1+patch_pixel_z1] = 1
