...
def test_all_case(model, image_list, num_classes, patch_size=(112, 112, 80), stride_xy=18, stride_z=4, save_result=True,
    ...
    total_metric = 0.0
    ith = 0
    predictions = []  # List to store predictions for all cases
    score_maps = []  # List to store score maps for all cases
    ...
    for image_path in loader:
        ...
        score_maps.append(score_map)  # Append score map to the list
    ...
    return predictions, score_maps, avg_metric  # Return predictions, score_maps, and avg_metric
