...
from networks.net_factory import net_factory, PREM_net
...
def Inference(FLAGS):
    ...
    snapshot_path = "../model/PREM/ACDC_{}_{}_labeled/{}".format(FLAGS.exp, FLAGS.labelnum, FLAGS.stage_name)
    test_save_path = "../model/PREM/ACDC_{}_{}_labeled/{}_predictions/".format(FLAGS.exp, FLAGS.labelnum,FLAGS.model)
    # if os.path.exists(test_save_path):
    #     shutil.rmtree(test_save_path)
    # os.makedirs(test_save_path)
    if FLAGS.stage_name == 'self_train':
